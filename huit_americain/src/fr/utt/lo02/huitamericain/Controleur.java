...
import fr.utt.lo02.vue.ConsoleView;
import fr.utt.lo02.vue.GUIView;
import fr.utt.lo02.vue.View;
...
public class Controleur {
	...
	/**
	 * Attend que l'utilisateur entre certaines valeurs sans quoi il renvoie
	 * l'exception WrongInputException.
	 * 
	 * @param motsAttendu
	 *            Array de String contenant les mots attendus par la méthode.
	 * @param entierAttendu
	 *            Booléen un indiquant si la valeur atendue peut être un entier ou
	 *            non.
	 * @param borneInf
	 *            Borne inférieure de l'entier attendu
	 * @param borneSup
	 *            Borne supérieure de l'entier attendu
	 * @return La valeur de ce qu'a entré l'utilisateur, un String ou un int.
	 * @throws WrongInputException
	 */
	public Object attendreValeur(String[] motsAttendu, boolean entierAttendu, int borneInf, int borneSup)
			throws WrongInputException {
	...
	/**
	 * Surcharge. Attends que l'utilisateur entre une certaine commande passée en
	 * liste de String en argument.
	 * 
	 * @param motsAttendu
	...
	/**
	 * Modifie la dernière commande entrée par l'utilisateur.
	 * En plus de cela, il reveille tous les thread qui attendent cet objet.
	 * @param arg Commande entrée (int ou String)
	 */
	...
	/**
	 * Retourne la dernière commande de l'utilisateur.
	 * @return Dernière entrée de l'utilisateur
	 */
