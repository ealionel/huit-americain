...
import fr.utt.lo02.huitamericain.*;

/**
 * Cette interface correspond à "Strategie" dans le patron de conception
 * Strategy. Il implémente les différentes méthodes qui peuvent potentiellement
 * avoir des variations dans les stratégies.
 * 
 * @author Lionel EA
 *
 */
