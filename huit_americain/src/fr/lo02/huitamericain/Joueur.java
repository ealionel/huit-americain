...
public abstract class Joueur extends Observable { // On la déclare abstraite parce que le joueur est soit réel soit
													// virtuel toute facon
	...
	public Joueur(String nom) {
		id = instancesJoueurs; // Pour donner un identifiant à chaque joueur, le joueur 0 sera toujours le
								// joueur réel
		instancesJoueurs++;
		this.nom = nom;
	...
	/**
	 * Fait piocher le joueur. Cette méthode récupère la première carte de la pioche
	 * et la donne au joueur.
	 * 
	 * @param pioche
	 *            Prends en paramètre une pioche.
	 */
	 ...
	 * 
	 * @param indice
	 *            Indice de la carte ciblée.
	 * @param talon
	 *            Talon ciblé.
	 */
	public void poserCarte(int indice, Talon talon) { // En fonction de si le joueur est réel ou virtuel, il fera des
														// choses diff�rentes (attendre que le joueur joue, ou jouer
														// automatiquement.)
	...
	/**
	 * Annoncer "CARTE" ou "CONTRE CARTE", si l'annonce n'est pas valable, le joueur
	 * qui a parle pioche une carte.
	 * 
	 * @param direCarte
	 *            Dire "CARTE" (true) ou dire "CONTRE-CARTE" (false).
	 * @param partie
	...
	/**
	 * Retourne la vulnérabilité du joueur. Un joueur est vulnérable par une
	 * commande "contre-carte" si le joueur possède une carte et n'a pas annoncé
	 * "carte"
	 * 
